intro_panel <- mainPanel(
  ...
  p("Are the richest countries the ones that produce the most CO2? Are they the
    ...
    might relate to its ", em(strong("CO2 emissions per capita,")), 
  ...
  p("We established three guiding questions (one for each topic) and answered the questions with different kinds of graphs.", 
    br(), br(),
    strong("(1)"),
    "How does employment to population ratio vary by income brackets in each region?",
    br(),
    strong("(2)"),
    "Is there a correlation between a country's CO2 emissions produced and income per capita?", 
    br(),
    strong("(3)"),
    "Is there a correlation between a country's current population in primary/secondary schools and income per capita?", 
    br(), br(),
